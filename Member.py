...
class Member(object):
    def __init__(self, member_id: int):
        ...
        self._veteran = False
        self._tenured = False
        self._age = test_helpers.lookup_age(self._member_id)
        assert self._age >= 0, "You must be born to enter the movie"
        assert self._age <= 124, "You can't be the oldest person alive"
